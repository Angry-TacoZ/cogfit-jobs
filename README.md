...
Live profile generation and job evaluation run through Firebase callable Cloud Functions. The browser never receives the Gemini API key. Profile answers, generated profiles, evaluations, and feedback are still stored in `localStorage` for this MVP.
